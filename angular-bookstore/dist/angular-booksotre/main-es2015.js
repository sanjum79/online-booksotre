...
let BookListComponent = class BookListComponent {
    constructor(_bookService, _activatedRoute) {
    ...
    listBooks() {
        ...
        this._bookService.getBooks(this.currentCategoryId).subscribe(listOfBooks => this.books = listOfBooks);
    }
};
...
let BookService = class BookService {
    ...
    getBooks(theCategoryId) {
        const searchUrl = `${this.baseUrl}/search/categoryid?id=${theCategoryId}`;
        return this.httpClient.get(searchUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(response => response._embedded.books));
    }
};
